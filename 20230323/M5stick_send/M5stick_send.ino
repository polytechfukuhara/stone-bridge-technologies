...
// Wi-Fi環境
const char* ssid = "HUAWEI Mate 20 X";    //"Galaxy_5GMW_4643"
const char* password = "hyhyhyhy";       //"kenta7766"

// Line Notify環境
const char* host = "notify-api.line.me";
const char* token = "GpAieMJarBlVGivBBYCDmHnrts3aaarNNjy0WtoVQCU"; // トークン
